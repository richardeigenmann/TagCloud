/*
SampleGradientColors.java:  A helper to pick the color along a gradient Line.
...
public class SampleGradientColors extends ColorInterpolator  {
     ...
     */
    private static final Logger LOGGER = Logger.getLogger(SampleGradientColors.class.getName());
    /**
